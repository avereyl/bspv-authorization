...
public class Authorities extends TableImpl<AuthoritiesRecord> {
    ...
    /**
     * The column <code>PUBLIC.AUTHORITIES.SERVICE</code>.
     */
    public final TableField<AuthoritiesRecord, String> SERVICE = createField("SERVICE", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false), this, "");
