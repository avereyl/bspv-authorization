...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record6<UUID, Long, String, String, Boolean, String> {
    ...
    private static final long serialVersionUID = -2089191291;
     ...
     */
    public UsersRecord(UUID id, Long version, String username, String password, Boolean enabled, String email) {
        super(Users.USERS);
